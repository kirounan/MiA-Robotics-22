...
def simulate(cat_states, cat_controls, t, step_horizon, N, reference,obs,robots_number, save=False):
    ...
    for j in range(robots_number):
        circle.append(plt.Circle((obs[3*j], obs[3*j+1]), obs[3*j+2], color='r'))
