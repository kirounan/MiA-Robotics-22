...
def simulate(cat_states, cat_controls, t, step_horizon, N, reference,x_o1,y_o1,r_o1,x_o2,y_o2,r_o2, save=False):
    ...
    if r_o1 != 0 and r_o2 !=0:
        circle1 = plt.Circle((x_o1,y_o1),r_o1,color='r')
        circle2 = plt.Circle((x_o2, y_o2), r_o2, color='g')
        fig = plt.gcf()
        ax = fig.gca()
